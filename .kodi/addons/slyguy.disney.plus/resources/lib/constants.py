APP_VERSION = '26.6.0+rc5-2026.04.21.0'
...
CONFIG_URL = 'https://client-sdk-configs.bamgrid.com/bam-sdk/v{}/{}/android/v{}/google/tv/prod.json'.format(SDK_VERSION, CLIENT_ID, CLIENT_VERSION)
